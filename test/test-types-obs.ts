...
console.log('All OBS type tests passed!', putPromise, url, initResult, uploadPartResult, completeResult, abortResult, listPartsResult, listUploadsResult, copyResult, multiResult, boundPromise);
